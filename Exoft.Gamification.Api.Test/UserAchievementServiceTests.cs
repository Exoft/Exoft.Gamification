...
namespace Exoft.Gamification.Api.Test
{
    ...
    public class UserAchievementServiceTests
    {
        ...
        {
            //Arrange
            var userAchievementService = new UserAchievementService(_userRepository.Object, _achievementRepository.Object, _userAchievementRepository.Object,
            ...
            // Act
            await userAchievementService.AddAsync(user.Id, achievement.Id);
        ...
        public async Task DeleteAsync_ValidUserAchievementId(Guid userAchievementId)
        {
            ...
            // Act
            await userAchievementService.DeleteAsync(userAchievementId);
        ...
        public async Task GetAllAchievementsByUserAsync(PagingInfo pagingInfo)
        {
            ...
            // Act
            var response = await userAchievementService.GetAllAchievementsByUserAsync(pagingInfo, user.Id);
        ...
        public async Task GetUserAchievementByIdAsync()
        {
            ...
            // Act
            var response = await userAchievementService.GetUserAchievementByIdAsync(userAchievement.Id);
        ...
        public async Task ChangeUserAchievementsAsync_ValidAssignAchievementsToUserModel(AssignAchievementsToUserModel model)
        {
            ...
            // Act
            await userAchievementService.ChangeUserAchievementsAsync(model, user.Id);
